...
final class CommunicationSeederDefaults implements ServiceContract
{
  ...
  private function extendedTemplates(): array
  {
    ...
    return [
      ...
      'event.accommodation.pairing.invited' => $this->tpl(
        'event-accommodation-pairing-invited',
        'Accommodation sharing invitation',
        'events',
        'event.accommodation.pairing.invited',
        'Sharing request — {{event_name}}',
        '<p>Hello {{applicant_name}},</p><p>{{requester_name}} has requested to share accommodation with you for <strong>{{event_name}}</strong>.</p><p>Please accept or decline in your workspace.</p>',
        $v(['applicant_name', 'event_name', 'requester_name', 'registration_number']),
        ['requester_name' => 'Ada'],
      ),
      ...
      'event.transport.assigned' => $this->tpl(
        'event-transport-assigned',
        'Transportation assigned',
        'events',
        'event.transport.assigned',
        'Transport assigned — {{event_name}}',
        '<p>Hello {{applicant_name}},</p><p>Your transportation for <strong>{{event_name}}</strong> has been assigned.</p><p>Route: {{pickup}} to {{destination}}<br>Vehicle: {{vehicle}}</p>',
        $v(['applicant_name', 'event_name', 'pickup', 'destination', 'vehicle', 'service_status']),
        ['pickup' => 'Airport', 'destination' => 'Hotel', 'vehicle' => 'Van 2'],
      ),
      'event.travel.quote' => $this->tpl(
        'event-travel-quote',
        'Travel quote provided',
        'events',
        'event.travel.quote',
        'Travel quote — {{event_name}}',
        '<p>Hello {{applicant_name}},</p><p>A travel quote is ready for <strong>{{event_name}}</strong>.</p><p>{{service_details_html}}</p>',
        $v(['applicant_name', 'event_name', 'service_details_html', 'service_status']),
        [],
      ),
