...
final class PermissionCatalog
{
  ...
  private static function community(): array
  {
    return [
      ...
      self::entry('Manage Event Accommodation', 'accommodation.manage', 'community', 'events', 'Manage event accommodation inventory, pairings, and allocations.'),
      self::entry('Manage Event Logistics', 'logistics.manage', 'community', 'events', 'Manage event transport routes, vehicles, and trips.'),
      self::entry('Manage Event Travel Assistance', 'travel.manage', 'community', 'events', 'Manage event travel assistance requests and quotes.'),
      ...
      self::entry('Export Business Reviews', 'business-review.export', 'community', 'business-review', 'Export Faith & Works business review submissions.'),
    ];
  }
